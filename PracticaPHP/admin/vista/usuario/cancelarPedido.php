...
<body>
 ...
 ?>
 <form  method="POST" action="../../controladores/usuario/cancelarPedido.php">
...
?>" disabled/>
 ...
 <input class="button" type="submit" id="cancelar" name="cancelar" value="CANCELAR" />
 <button  class="button"> <a href="consulta.php"> REGRESAR</a></button>
 </form> 
 <?php
 }
 } else { 
